import reducer, {loadFilms, setFilms, selectFilms, addFilm, updateFilm, deleteFilm} from "./films.slice";
...
describe('search params slice', () => {
    ...
    describe('reducer and actions', () => {
        ...
        it('should properly handle error when loadFilms', (done) => {
            ...
            FilmApi.loadFilms.mockReturnValueOnce(Promise.reject('error'));
        ...
        it('should properly handle error when addFilm', (done) => {
            const onError = jest.fn();
            FilmApi.createFilm.mockReturnValueOnce(Promise.reject('error'));
        ...
        it('should properly handle error when updateFilm', (done) => {
            const onError = jest.fn();
            FilmApi.updateFilm.mockReturnValueOnce(Promise.reject('error'));
        ...
        it('should properly handle error when deleteFilm ', (done) => {
            const onError = jest.fn();
            FilmApi.deleteFilm.mockReturnValueOnce(Promise.reject('error'));
