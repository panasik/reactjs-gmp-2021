...
import DropdownSelector from '../../../general/dropdown-selector/dropdown-selector';
...
function AddEditFilmForm({
  film, genres, setFieldValue, handleReset,
}) {
  ...
  return (
    <Form>
      <div className="DialogContainer">
        ...
        <FormItem name="title" label="Title" type="text" />

        <FormItem name="release_date" label="Release Date" type="date" />

        <FormItem name="poster_path" label="Movie Poster URL" type="text" />

        <Field name="genres">
          {({ field, meta }) => (
            <>
              <label className="FormItemLabel">Genres</label>
              <DropdownSelector
        ...
        <FormItem name="overview" label="Overview" type="text" />

        <FormItem name="runtime" label="Runtime" type="text" />
      </div>
      <div className="DialogActionContainer">
        ...
        <button type="submit" tabIndex={0} className="PrimaryButton">
