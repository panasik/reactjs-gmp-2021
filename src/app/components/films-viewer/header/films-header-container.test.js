...
jest.mock('./view-header/view-header', () => ({
  // eslint-disable-next-line react/prop-types
  onAddFilm, updateSearchStr, searchString,
}) => (
  <div className="ViewerHeaderTest">
    <div onClick={onAddFilm}>Add</div>
    <div onClick={() => updateSearchStr(searchString)}>Search</div>
  </div>
));
...
describe('FilmsHeaderContainer', () => {
  it('should init correctly', async () => {
    ...
    expect(
      container.querySelector('.FilmDetailsHeaderTest'),
    ).toBeInTheDocument();
  });
