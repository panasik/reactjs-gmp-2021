...
jest.mock('../../../../../res/img/no-image.png', () => '');
...
describe('FilmItem', () => {
    ...
    it('should display menu on hover', () => {
        ...
        expect(container.querySelector('.context-menu-container')).toBeNull();

        const item = container.querySelector('.FilmItem');
        userEvent.hover(item);

        expect(container.querySelector('.context-menu-container')).toBeInTheDocument();
    ...
    it('should handle click', (done) => {
        const {container} = render(<FilmItem actions={[]} film={{...film, genres: null, poster_path : null}}
            clickHandler={() => {
                expect(true).toBeTruthy();
                done();
            }
